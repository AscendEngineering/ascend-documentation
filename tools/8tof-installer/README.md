...
`docs/ascend-8tof/08-install-firmware.md`.

When publishing another version, update the versioned ZIP and checksum, then
copy its installer files here so the downloadable and reviewable versions match.
Do not include per-board backups or local device logs in this repository.
